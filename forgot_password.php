...
<body>
    <div class="forgot-container">
        <div class="forgot-header">
            <div class="logo" style="width: 60px; height: 60px; font-size: 1.8rem; margin-bottom: 10px;"><i class="fas fa-key"></i></div>
            <h2 style="font-size: 1.5rem; margin-bottom: 5px;">Forgot Password?</h2>
            <p style="font-size: 0.85rem; margin-bottom: 15px;">Enter your username or email below to generate a reset link.</p>
        </div>
        ...
        <?php if (empty($reset_link)): ?>
            ...
            <form method="POST">
                ...
                <div class="form-group mb-2">
                    <label class="mb-1" style="font-size: 0.85rem;"><i class="fas fa-shield-alt"></i> Security Verification</label>
